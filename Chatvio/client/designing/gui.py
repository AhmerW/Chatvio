...
class listener(object):
    """
    A small api to handle events in the GUI.
    e.g: when a button is pressed or window is closed, etc..
    """
    def __init__(self):
       self.events = {}
...
class Ui_Chatvio(object):
    def setupUi(self, Chatvio):
        ...
        #credits to https://github.com/sommerc
...
"")
    ...
    def retranslateUi(self, Chatvio):
        ## set title to concat "Not logged in" or "Logged in as"
        ## dependent on wheter user is logged in or not
        _translate = QtCore.QCoreApplication.translate
        Chatvio.setWindowTitle(_translate("Chatvio", "Chatvio"))
