...
# Form implementation generated from reading ui file 'MainDesign - Copy.ui'
#
...
class Ui_Chatvio(object):
    def setupUi(self, Chatvio):
        ...
        Chatvio.resize(800, 600)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        Chatvio.setFont(font)
        Chatvio.setStyleSheet("QToolTip\n"
"{\n"
...
"")
        ...
        self.label.setGeometry(QtCore.QRect(30, 10, 561, 91))
        ...
        brush = QtGui.QBrush(QtGui.QColor(224, 119, 20, 128))
        ...
        self.groupBox.setGeometry(QtCore.QRect(240, 170, 341, 361))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(224, 119, 20))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        ...
        self.pushButton_2.setGeometry(QtCore.QRect(10, 300, 121, 51))
        ...
        self.actionChange_settings = QtWidgets.QAction(Chatvio)
    ...
    def retranslateUi(self, Chatvio):
        ...
        Chatvio.setWindowTitle(_translate("Chatvio", "by Waz"))
        Chatvio.setWhatsThis(_translate("Chatvio", "Create a public or private meeting"))
        self.label.setText(_translate("Chatvio", "Waz - Chat app"))
        self.pushButton_3.setWhatsThis(_translate("Chatvio", "Create a public or private meeting"))
        self.pushButton_3.setText(_translate("Chatvio", "Join room"))
        self.pushButton_4.setText(_translate("Chatvio", "Leave room"))
        self.pushButton_2.setText(_translate("Chatvio", "Login"))
        ...
        self.actionChange_settings.setText(_translate("Chatvio", "Change settings"))
